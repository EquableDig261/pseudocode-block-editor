...
export const LIBRARY_BOXES: { boxes: LibraryBox[]; color: string; }[] = [        
    ...
    {boxes: [{type: BOX_TYPES.SUB_BLOCK, contents: [{subBoxType: SUB_BOX_TYPES.EMPTY, returnTypes: [RETURN_TYPES.VARIABLE]}, "[", {subBoxType: SUB_BOX_TYPES.EMPTY, returnTypes: [RETURN_TYPES.NUMBER]}, "]"], returnType: RETURN_TYPES.VARIABLE}], color: COLORS.PURPLE},
    {boxes: [{type: BOX_TYPES.SUB_BLOCK, contents: ["{", {subBoxType: SUB_BOX_TYPES.EMPTY, returnTypes: RETURN_TYPES.ANY}, "}"], returnType: RETURN_TYPES.VARIABLE}], color: COLORS.PURPLE},
    {boxes: [{type: BOX_TYPES.SUB_BLOCK, contents: [{subBoxType: SUB_BOX_TYPES.EMPTY, returnTypes: RETURN_TYPES.ANY}, ", ", {subBoxType: SUB_BOX_TYPES.EMPTY, returnTypes: RETURN_TYPES.ANY}], returnType: RETURN_TYPES.VARIABLE}], color: COLORS.PURPLE},
